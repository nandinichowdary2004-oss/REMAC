    ...
    try:
        while True:
            ...
            for unit in STORAGE_UNITS:
                ...
                try:
                    res_lat = requests.post(f"https://kvdb.io/remac_mvp_7bf9bd4f/latest_{u_id}", json=payload, timeout=2)
                    res_hist = requests.post(f"https://kvdb.io/remac_mvp_7bf9bd4f/history_{u_id}", json=history_tracks[u_id], timeout=2)
                except Exception as e:
                    pass
